"""
The Smart-Contract library contains all integration points that persist or consult data on the blockchain.
"""
import time
...
from energyweb import BlockchainClient, Energy
