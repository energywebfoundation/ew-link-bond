...
from energyweb.oldconfig import EnergyAssetConfiguration
...
class EnergyLogger(Logger):
    ...
    def log_measured_energy(self) -> (EnergyData, EnergyData):
        """
    ...
    def __transform(self, raw_energy: EnergyData) -> EnergyData:
        """
